    ...
    <div ref={sectionRef} className="character-to-prize-trigger w-full h-screen flex items-center justify-center bg-black overflow-hidden perspective">
      ...
      <div className="container relative z-10 mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-12">
        ...
        <div className="w-full md:w-1/2 text-white space-y-6">
          <h1 className="hero-text text-6xl md:text-8xl font-bold bg-gradient-to-r from-yellow-400 to-yellow-200 bg-clip-text text-transparent leading-tight" style={{ fontFamily: 'var(--font-knight-warrior), sans-serif' }}>
            LIFE IS A KHEL
          </h1>
          <p className="hero-text text-xl text-gray-300 font-light leading-relaxed">
